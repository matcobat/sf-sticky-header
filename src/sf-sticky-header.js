                ...
                function setColumnHeaderSizes() {
                    if (clonedHeader.is('tr') || clonedHeader.is('thead')) {
                        ...
                        header.find('th').each(function(index, column) {
                            ...
                            // fluid thead / table
                            var finalWidthSet = column.offsetWidth / (header.outerWidth()) * 100; // $(window) can be replace with a custom wrapper / container
        ...
        return {
            ...
            link: function(scope, element, attrs, controller, transclude) {
                ...
                transclude(function(clone, transcludedScope) {
                    ...
                    function nextPage() {
                        var dataSlice = sortedData;
                        if (pageSize != 0) {
                            dataSlice = sortedData.slice(pageSize * currentPage, (pageSize * (currentPage + 1)));
                        }
